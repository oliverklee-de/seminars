...
$tca = [
    'ctrl' => [
        ...
        'iconfile' => 'EXT:seminars/Resources/Public/Icons/SingleEvent.svg',
        'typeicon_column' => 'object_type',
        'typeicon_classes' => [
            'default' => 'tx-seminars-single-event',
            EventInterface::TYPE_SINGLE_EVENT => 'tx-seminars-single-event',
    ...
    'columns' => [
        ...
        'timeslots' => [
            ...
            'config' => [
                ...
                'foreign_default_sortby' => 'begin_date',
                'maxitems' => 999,
                'appearance' => [
