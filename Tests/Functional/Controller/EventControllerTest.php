...
final class EventControllerTest extends FunctionalTestCase
{
     ...
     * @test
     */
    public function archiveActionRendersTeaser(): void
    {
        $this->importCSVDataSet(self::FIXTURES_PATH . '/archiveAction/EventArchiveContentElement.csv');
        $this->importCSVDataSet(self::FIXTURES_PATH . '/archiveAction/PastEventWithTeaser.csv');
     ...
     * @test
     */
    public function archiveActionForEventDateRendersCategories(): void
    {
        $this->importCSVDataSet(self::FIXTURES_PATH . '/archiveAction/EventArchiveContentElement.csv');
        $this->importCSVDataSet(self::FIXTURES_PATH . '/archiveAction/PastEventDateWithTwoCategories.csv');
     ...
     * @test
     */
    public function outlookActionRendersTeaser(): void
    {
        $this->importCSVDataSet(self::FIXTURES_PATH . '/outlookAction/EventOutlookContentElement.csv');
        $this->importCSVDataSet(self::FIXTURES_PATH . '/outlookAction/FutureEventWithTeaser.csv');
     ...
     * @test
     */
    public function outlookActionForEventDateRendersTeaser(): void
    {
        $this->importCSVDataSet(self::FIXTURES_PATH . '/outlookAction/EventOutlookContentElement.csv');
        $this->importCSVDataSet(self::FIXTURES_PATH . '/outlookAction/FutureEventDateWithTopicAndTeaser.csv');
    ...
    {
        $this->importCSVDataSet(self::FIXTURES_PATH . '/showAction/EventSingleViewContentElement.csv');
        $this->importCSVDataSet(self::FIXTURES_PATH . '/showAction/FutureEventWithTwoCategories.csv');
    ...
    {
        $this->importCSVDataSet(self::FIXTURES_PATH . '/showAction/EventSingleViewContentElement.csv');
        $this->importCSVDataSet(self::FIXTURES_PATH . '/showAction/FutureEventDateWithTwoCategories.csv');
    ...
    {
        $this->importCSVDataSet(self::FIXTURES_PATH . '/showAction/EventSingleViewContentElement.csv');
        $this->importCSVDataSet(self::FIXTURES_PATH . '/showAction/FutureEventWithTwoOrganizers.csv');
