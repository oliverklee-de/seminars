...
- Add support for TYPO3 12LTS (#5281, #5286, #5294)
...
- Restyle the FE list views (#5043, #5117, #5229, #5307, #5311, #5312, #5313)
...
- Add a new plugin for the event archive, outlook and single view
  ...
  #4138, #4353)
- Re-add the FE editor (#3894, #3903, #3904, #4814)
...
- Require oelib >= 6.3.1
  (#3500, #3555, #3674, #4009, #4013, #4300, #4892, #4938, #4994)
